...
| ------------------------ | ---------------------------------------------- | ------------------------------------------------- |
| **Skeleton loading**     | Placeholder shimmer while content loads        | ![Skeleton Demo](./docs/gif/skeleton-loading.gif) |
| **Floating label**       | Input labels float smoothly on focus           | ![Label Demo](./docs/gif/floating-label.gif)      |
| **Tooltip hover**        | Subtle tooltip reveal with fade/slide motion   | ![Tooltip Demo](./docs/gif/tooltip.gif)           |
